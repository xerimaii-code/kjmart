...
export const NewOrderIcon = ({className, ...props}: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);
...
export const AddIcon = ({className, ...props}: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" /></svg>
);
...
export const ArrowLongRightIcon = ({className, ...props}: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
      {props.title && <title>{props.title}</title>}
...
export const GoogleIcon = ({className, ...props}: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} viewBox="0 0 48 48" {...props}>
        {props.title && <title>{props.title}</title>}
        ...
        <path fill="#34A853" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4C12.955 4 4 12.955 4 24s8.955 20 20 20s20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z" transform="rotate(360 26 26)" />
        <path fill="#FBBC05" d="M24 4c-5.268 0-10.046 2.053-13.575 5.425L16.082 15.082C18.158 13.154 20.941 12 24 12c6.627 0 12 5.373 12 12s-5.373 12-12 12c-5.217 0-9.649-3.34-11.303-8H24v-8H42v.083C43.862 22.65 44 21.341 44 20c0-11.045-8.955-20-20-20z" transform="rotate(360 26 26)" />
        <path fill="#EA4335" d="M4.389 28.083C4.138 26.65 4 25.341 4 24c0-1.341.138-2.65.389-3.917L10.046 25.425C9.842 26.26 9.75 27.125 9.75 28c0 2.25.463 4.384 1.285 6.328l-5.657 5.657C5.954 36.046 4 31.268 4 24z" transform="rotate(360 26 26)" />
    </svg>
);
