                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <div className="flex items-center justify-center space-x-2">
                                <button onClick={() => changeQuantity(-1)} className="w-11 h-11 bg-gray-200 text-gray-700 text-2xl font-bold rounded-lg transition hover:bg-gray-300 active:scale-95 flex-shrink-0 flex items-center justify-center" aria-label="수량 감소">-</button>
                                <input 
                                    ref={inputRef}
                                    id="edit-quantity"
                                    type="number" 
                                    ...
                                    autoComplete="off"
                                />
                                <button onClick={() => changeQuantity(1)} className="w-11 h-11 bg-gray-200 text-gray-700 text-2xl font-bold rounded-lg transition hover:bg-gray-300 active:scale-95 flex-shrink-0 flex items-center justify-center" aria-label="수량 증가">+</button>
                            </div>
                        </div>
