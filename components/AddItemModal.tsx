                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <div className="flex items-center justify-center space-x-2">
                                ...
                                />
                                <button onMouseDown={(e) => e.preventDefault()} onClick={() => changeQuantity(1)} className="w-10 h-10 bg-gray-200 text-gray-700 text-2xl font-bold rounded-full transition hover:bg-gray-300 active:scale-95 flex-shrink-0" aria-label="수량 증가">+</button>
                            </div>
                        </div>
                ...
                <div className="bg-gray-50 px-4 py-2.5 rounded-b-xl">
                    {isContinuousScan ? (
                        <div className="space-y-2">
                             <button onMouseDown={(e) => e.preventDefault()} onClick={handleAddAndScan} className="w-full text-white px-4 h-[4.5rem] flex items-center justify-center rounded-lg font-bold bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-base">
                                추가 후 계속 스캔
                            </button>
                            <div className="grid grid-cols-2 gap-2">
                                <button onMouseDown={(e) => e.preventDefault()} onClick={() => { if (onNextScan) { onClose(); onNextScan(); } }} className="px-4 h-10 flex items-center justify-center rounded-lg font-semibold text-blue-600 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-400 transition text-sm">
                                    건너뛰기
                                </button>
                                <button onMouseDown={(e) => e.preventDefault()} onClick={onClose} className="px-4 h-10 flex items-center justify-center rounded-lg font-semibold text-gray-600 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 transition text-sm">
                                    스캔 종료
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button onMouseDown={(e) => e.preventDefault()} onClick={onClose} className="px-4 h-[4.5rem] flex items-center justify-center rounded-lg font-semibold text-gray-600 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 transition text-base">
                                취소
                            </button>
                            <button onMouseDown={(e) => e.preventDefault()} onClick={handleAdd} className="text-white px-4 h-[4.5rem] flex items-center justify-center rounded-lg font-bold bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-base">
