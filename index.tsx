...
type Page = 'new-order' | 'history' | 'settings';
...
const AppContent: React.FC = () => {
    ...
    return (
        <div className="h-full w-full flex flex-col">
            <Header />
            <main className="main-content flex-grow relative">{renderPage()}</main>
