...
const AppContent: React.FC = () => {
    ...
    const isAnyInputModalOpen = !!addItemModalProps || !!editItemModalProps || !!isClearHistoryModalOpen || !!isDeliveryModalOpen || window.history.state?.modal === 'receiveItem' || window.history.state?.modal === 'auditItem';
