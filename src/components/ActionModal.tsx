...
const ActionModal: React.FC<ActionModalProps> = ({ isOpen, onClose, title, children, footer, headerActions, containerRef, heightClass, disableBodyScroll, zIndexClass = 'z-30' }) => {
