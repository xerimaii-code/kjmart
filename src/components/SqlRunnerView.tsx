...
import { SpinnerIcon, TrashIcon, PencilSquareIcon, PlayCircleIcon, BookmarkSquareIcon, StopCircleIcon, SparklesIcon, StarIcon, ClipboardIcon, DragHandleIcon, ShieldCheckIcon, CalendarIcon, ChevronDownIcon } from './Icons';
                                    ...
                                    <div className="flex items-center gap-3 overflow-hidden">
                                        ...
                                        <div className="min-w-0">
                                            <h3 className="font-bold text-gray-800 truncate flex items-center gap-2">
                                                {q.name}
                                                {q.isImportant && <ShieldCheckIcon className="w-4 h-4 text-amber-500" title="중요 쿼리" />}
                                            </h3>
                                        </div>
                                    </div>
