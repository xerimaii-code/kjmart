...
const Toast: React.FC<ToastProps> = ({ isOpen, message, type, onClose }) => {
    ...
    return (
        <div 
             ...
             className={`fixed inset-x-0 mx-auto z-[120] w-[90%] max-w-sm p-2 rounded-lg shadow-2xl text-white font-semibold flex items-center gap-2 animate-fade-in-down ${bgColor}`}
        >
