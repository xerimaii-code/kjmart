...
import { DeviceSettings, ScannerContext as ScannerContextType, ScannerOptions } from '../types';
...
const CoreAppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    }, [user, initialSyncCompleted, checkSql, syncWithDb, loadLocalData, showToast, setInitialSyncCompleted, setSyncStatusText]);
