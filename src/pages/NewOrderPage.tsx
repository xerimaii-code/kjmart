...
const NewOrderPage: React.FC<{ isActive: boolean }> = ({ isActive }) => {
    ...
    const { searchTerm: productSearch, setSearchTerm: setProductSearch, results: productSearchResults, isSearching: isSearchingProducts } = useProductSearch('newOrder');
    const debouncedProductSearch = useDebounce(productSearch, 300); // For dropdown visibility
    ...
    const { draft, isLoading: isDraftLoading, save: saveDraftData, remove: removeDraftData } = useDraft<NewOrderDraft>(DRAFT_KEY);
        ...
        <div className="h-full flex flex-col relative bg-white">
            ...
            <div className="w-full py-2 px-3 bg-white flex-shrink-0 z-20 border-b border-gray-200">
                <div className="grid grid-cols-[1fr_auto] items-stretch gap-2 w-full max-w-2xl mx-auto">
                    ...
                    {isCustomerSelected && (
                         <div className="w-20 bg-blue-600 text-white rounded-lg flex flex-col items-center justify-center gap-1 font-bold hover:bg-blue-700 transition active:scale-95 shadow shadow-blue-500/30">
