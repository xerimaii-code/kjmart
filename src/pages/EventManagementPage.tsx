            ...
            <div className="p-3 bg-slate-100 border-b border-slate-200 space-y-2 flex-shrink-0 z-20 shadow-sm">
                <div className="flex gap-2">
                    <input 
                        ...
                        className="flex-1 h-10 border border-gray-200 rounded-lg px-2 text-sm font-bold bg-white text-gray-700 focus:ring-1 focus:ring-indigo-500 outline-none" 
                    />
                ...
                <div className="flex gap-2 items-stretch">
                    <select 
                        ...
                        className="w-1/4 h-11 border border-gray-200 rounded-xl px-2 text-xs font-bold bg-white text-gray-700 focus:ring-1 focus:ring-indigo-500 outline-none"
                    >
