                ...
                <div className="space-y-3">
                    <div className="space-y-1">
                        ...
                        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2">
                            <input type="date" value={startDate} onChange={e => setStartDate(e.target.value)} className="h-10 border border-gray-200 rounded-xl px-2 text-[14px] font-bold focus:ring-1 focus:ring-indigo-500 outline-none bg-white w-full shadow-sm"/>
                            <span className="font-bold text-gray-300">~</span>
                            <input type="date" value={endDate} onChange={e => setEndDate(e.target.value)} className="h-10 border border-gray-200 rounded-xl px-2 text-[14px] font-bold focus:ring-1 focus:ring-indigo-500 outline-none bg-white w-full shadow-sm"/>
                        </div>
                    </div>
                    <div className="space-y-1">
