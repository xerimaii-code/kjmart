...
const EditQueryModal: React.FC<{
    query: SavedQuery | null;
    onClose: () => void;
    onSave: (id: string, updates: Partial<SavedQuery>) => void;
