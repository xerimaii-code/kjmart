...
interface UIActions {
    ...
    openAddItemModal: (props: NonNullable<UIState['addItemModalProps']>) => void;
    closeAddItemModal: () => void;
    openEditItemModal: (props: NonNullable<UIState['editItemModalProps']>) => void;
    closeEditItemModal: () => void;
    openMemoModal: (props: NonNullable<UIState['memoModalProps']>) => void;
    closeMemoModal: () => void;
}
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const [addItemModalProps, setAddItemModalProps] = useState<UIState['addItemModalProps']>(null);
    const [isEditItemModalOpen, setIsEditItemModalOpen] = useState(false);
    const [editItemModalProps, setEditItemModalProps] = useState<UIState['editItemModalProps']>(null);
    const [isMemoModalOpen, setIsMemoModalOpen] = useState(false);
    const [memoModalProps, setMemoModalProps] = useState<UIState['memoModalProps']>(null);
    ...
    const uiActions: UIActions = useMemo(() => ({
        ...
        openAddItemModal: (props) => {
            setAddItemModalProps(props);
            setIsAddItemModalOpen(true);
        },
        closeAddItemModal: () => {
            setIsAddItemModalOpen(false);
            setAddItemModalProps(null);
        },
        openEditItemModal: (props) => {
            setEditItemModalProps(props);
            setIsEditItemModalOpen(true);
        },
        closeEditItemModal: () => {
            setIsEditItemModalOpen(false);
            setEditItemModalProps(null);
        },
        openMemoModal: (props) => {
            setMemoModalProps(props);
            setIsMemoModalOpen(true);
        },
        closeMemoModal: () => {
            setIsMemoModalOpen(false);
            setMemoModalProps(null);
        },
